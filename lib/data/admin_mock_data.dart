...
const kClientMembers = [
  MemberRow(name: 'Amara Reed', contact: 'amara.reed@gmail.com · 24 orders', state: 'Active'),
  MemberRow(name: 'Owen Park', contact: 'owen.park@gmail.com · 11 orders', state: 'Active'),
  MemberRow(name: 'Hana Sato', contact: 'hana.sato@gmail.com · 3 orders', state: 'Pending'),
  MemberRow(name: 'Luis Ferrer', contact: 'luis.f@gmail.com · 7 orders', state: 'Suspended'),
];

const kVendorMembers = [
  MemberRow(name: 'Marina Fresh Laundry', contact: 'Selma Duarte · 34 orders today', state: 'Active'),
  MemberRow(name: 'Bright & Fold', contact: 'Tomas Lund · 28 orders today', state: 'Active'),
