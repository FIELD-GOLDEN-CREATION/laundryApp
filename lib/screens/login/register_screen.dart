...
class _RegisterScreenState extends ConsumerState<RegisterScreen> {
  ...
  Future<void> _register() async {
    ...
    final error = await ref.read(authProvider.notifier).registerClient(
      name: _name.text,
      email: _email.text,
      phone: _phone.text,
            ...
            children: [
              ...
              Container(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  SizedBox(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        child: Center(
                          child: _isSubmitting
                              ? const SizedBox(height: 20, width: 20, child: CircularProgressIndicator(strokeWidth: 2, color: AppColors.teal))
                              : Text('Sign up  →', style: AppText.sans(fontSize: 14.5, fontWeight: FontWeight.w800, color: AppColors.teal)),
                        ),
                      ),
                    ),
                  ),
                  ...
                  Center(
                    child: Text('OR SIGN UP WITH', style: AppText.sans(fontSize: 10.5, fontWeight: FontWeight.w800, letterSpacing: 1, color: AppColors.cream.withValues(alpha: 0.56))),
                  ),
...
class _SocialRegButton extends StatelessWidget {
  const _SocialRegButton({
    required this.label,
    required this.icon,
    required this.color,
