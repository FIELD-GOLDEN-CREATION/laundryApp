...
/// Full-bleed photo package card shared by Home's carousel and the
/// Packages page: photo + veil, kind/NEGOTIABLE pills, WhatsApp button,
/// serif name, scope line, and a bottom strip with price + select.
/// Tapping adds to the basket (or opens WhatsApp for ask-for-price).
class PackageShowcaseCard extends ConsumerWidget {
  const PackageShowcaseCard({super.key, required this.pkg});
